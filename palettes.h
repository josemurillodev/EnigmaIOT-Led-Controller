...
DEFINE_GRADIENT_PALETTE(Atlantica_gp) {
  ...
  DECLARE_GRADIENT_PALETTE(C9_2_gp);
  ...
  DECLARE_GRADIENT_PALETTE(C9_new_gp);
...
DECLARE_GRADIENT_PALETTE(temperature_gp);
DEFINE_GRADIENT_PALETTE(temperature_gp) {
  ...
  DECLARE_GRADIENT_PALETTE(Aurora2_gp);
...
DECLARE_GRADIENT_PALETTE(retro_clown_gp);
...
DECLARE_GRADIENT_PALETTE(candy_gp);
...
DECLARE_GRADIENT_PALETTE(toxy_reaf_gp);
...
DECLARE_GRADIENT_PALETTE(fairy_reaf_gp);
...
DECLARE_GRADIENT_PALETTE(semi_blue_gp);
...
DECLARE_GRADIENT_PALETTE(pink_candy_gp);
...
DECLARE_GRADIENT_PALETTE(red_reaf_gp);
...
DECLARE_GRADIENT_PALETTE(aqua_flash_gp);
...
DECLARE_GRADIENT_PALETTE(yelblu_hot_gp);
...
DECLARE_GRADIENT_PALETTE(lite_light_gp);
...
DECLARE_GRADIENT_PALETTE(red_flash_gp);
...
DECLARE_GRADIENT_PALETTE(blink_red_gp);
...
DECLARE_GRADIENT_PALETTE(red_shift_gp);
...
DECLARE_GRADIENT_PALETTE(red_tide_gp);
...
DECLARE_GRADIENT_PALETTE(candy2_gp);
...
// by name every time.
static CRGBPalette16 gGradientPalettes[] = {
  PartyColors_p,
  CloudColors_p,
  LavaColors_p,
  OceanColors_p,
